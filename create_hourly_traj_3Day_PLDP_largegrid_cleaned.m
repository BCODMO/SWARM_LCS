...
for i=datetime(2020,1,15,14,0,0):hours(1):datetime(2020,1,16,12,0,0)
...
%     DRIFTER=[];
    ...
    filename = strcat('traj_swarm_',num2str(year),'_',num2str(mon),'_',num2str(day),'_',num2str(hr), '_3day.mat');
